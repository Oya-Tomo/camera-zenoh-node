...
ZenohからJPEG frameをsubscribeし、最新frameをdecodeしてOpenCVで表示するexampleです。受信した最新JPEGだけを保持するため、表示が遅れてもframe queueが際限なく蓄積しません。
...
終了するときは`q`、`Esc`を押すか、OpenCV windowを閉じます。
